...
;
  cm_cdr_tax_growth = 1.05;            !! def =1.05
*'  (any number >= 0): rate of exponential increase over time
parameter
...
parameter
  c_target2050budget     "global emissions budget from 2020 until 2050"
;
  c_target2050budget      = -1; !! def =-1
*' -1 indicates no target, otherwise number indicates global cumulated emissions target until 2050 in GtCO2 

parameter
  cm_cdr2co2_price_ratio     "Ratio of CDR to CO2 price to be defined in separate market scenarios with fixed budgets but free timing of net-zero"
;
