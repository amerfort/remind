...
vm_co2CCS.up(t,regi,"cco2","ico2","ccsinje",rlf)$((t.val le 2030) AND (sameas(regi,"DEU"))) = 1e-3;

*** limit German CCS amount, conversion from MtCO2 to GtC
vm_co2CCS.up(t,regi,"cco2","ico2","ccsinje",rlf)$((c_deuCCSmax ge 0) AND (sameas(regi,"DEU"))) = c_deuCCSmax/ 1000 / sm_c_2_co2;
