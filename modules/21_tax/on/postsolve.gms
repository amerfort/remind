...
pm_taxrevGHG0(ttot,regi) = pm_taxCO2eqSum(ttot,regi) * (vm_co2eq.l(ttot,regi) + vm_emiCdrAll.l(ttot,regi)$((cm_iterative_target_adj eq 13) OR (cm_iterative_target_adj eq 11)) - vm_emiMacSector.l(ttot,regi,"co2luc")$(cm_multigasscen ne 3));
