...
pm_taxrevGHG0(t,regi) = pm_taxCO2eqSum(t,regi) * (vm_co2eq.l(t,regi) + vm_emiCdrAll.l(t,regi)$(cm_SepMarkCDR eq 1) - vm_emiMacSector.l(t,regi,"co2luc")$(cm_multigasscen ne 3));
