...
q21_taxrev(t,regi)$(t.val ge max(2010,cm_startyear))..
  ...
  - v21_taxrevCDR(t,regi)$(cm_SepMarkCDR eq 1) 
...
v21_taxrevGHG(t,regi) =e= pm_taxCO2eqSum(t,regi) * (vm_co2eq(t,regi) + vm_emiCdrAll(t,regi)$(cm_SepMarkCDR eq 1) - vm_emiMacSector(t,regi,"co2luc")$(cm_multigasscen ne 3))
