...
path_magpie <- "/p/tmp/amerfort/magpie/"
...
path_settings_coupled <- paste0(path_remind,"config/scenario_config_coupled_SSPSDP_4targets.csv")
path_settings_remind  <- paste0(path_remind,"config/scenario_config_4targets_4coupl.csv")
